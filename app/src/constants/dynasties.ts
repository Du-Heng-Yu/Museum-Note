...
export const DYNASTIES: Dynasty[] = [
  ...
  { id: 3,  name: '夏朝',         startYear: -2070,    endYear: -1600,        order: 3 },
  { id: 4,  name: '商朝',         startYear: -1600,    endYear: -1046,        order: 4 },
  ...
  { id: 8,  name: '秦朝',         startYear: -221,     endYear: -207,         order: 8 },
  { id: 9,  name: '西汉',       startYear: -206,     endYear: 8,            order: 9 },
  { id: 10, name: '新朝',         startYear: 9,        endYear: 24,           order: 10 },
  { id: 11, name: '东汉',       startYear: 25,       endYear: 220,          order: 11 },
  { id: 12, name: '三国',       startYear: 220,      endYear: 280,          order: 12 },
  { id: 13, name: '西晋',       startYear: 265,      endYear: 316,          order: 13 },
  { id: 14, name: '东晋',       startYear: 317,      endYear: 420,          order: 14 },
  { id: 15, name: '十六国',     startYear: 304,      endYear: 439,          order: 15 },
  { id: 16, name: '南北朝',     startYear: 420,      endYear: 589,          order: 16 },
  { id: 17, name: '隋朝',         startYear: 581,      endYear: 618,          order: 17 },
  { id: 18, name: '唐朝',         startYear: 618,      endYear: 907,          order: 18 },
  { id: 19, name: '五代十国',   startYear: 907,      endYear: 960,          order: 19 },
  { id: 20, name: '辽',         startYear: 916,      endYear: 1125,         order: 20 },
  { id: 21, name: '北宋',       startYear: 960,      endYear: 1127,         order: 21 },
  { id: 22, name: '南宋',       startYear: 1127,     endYear: 1279,         order: 22 },
  { id: 23, name: '西夏',       startYear: 1038,     endYear: 1227,         order: 23 },
  { id: 24, name: '金',         startYear: 1115,     endYear: 1234,         order: 24 },
  { id: 25, name: '元',         startYear: 1271,     endYear: 1368,         order: 25 },
  { id: 26, name: '明朝',         startYear: 1368,     endYear: 1644,         order: 26 },
  { id: 27, name: '清朝',         startYear: 1644,     endYear: 1911,         order: 27 },
